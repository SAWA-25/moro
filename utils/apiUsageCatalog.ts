...
export const API_USAGE_CATALOG = [
    ...
    feature('chat.customApi.fetchModels', AppID.GroupChat, '絮语', '聊天设置', '拉取自定义 API 模型', ['絮语', '聊天设置', '自定义 API', '拉取模型'], 'custom', false, '自定义 API'),
    feature('chat.scheduleApi.fetchModels', AppID.GroupChat, '絮语', '聊天设置', '拉取日程 API 模型', ['絮语', '聊天设置', '日程 API', '拉取模型'], 'custom', false, '今日日程 API'),
    feature('chat.moodApi.fetchModels', AppID.GroupChat, '絮语', '聊天设置', '拉取心情 API 模型', ['絮语', '聊天设置', '心情 API', '拉取模型'], 'custom', false, '心情 API'),
