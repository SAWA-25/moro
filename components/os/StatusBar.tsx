  ...
  return (
    <>
      <div 
          ...
          style={{ 
              color: textColor,
              paddingTop: 'var(--cutout-top)',
              height: 'auto',
              minHeight: 'calc(var(--cutout-top) + 1.35rem)'
          }}
      >
        <div className="w-1/3 pl-1 flex items-center gap-2 pointer-events-auto">
          <span>{format(virtualTime.hours)}:{format(virtualTime.minutes)}</span>
        </div>
        <div className="w-1/3 flex justify-center">
          {/* Notch Area spacer */}
        </div>
        <div className="w-1/3 flex justify-end gap-1.5 items-center pr-1">
