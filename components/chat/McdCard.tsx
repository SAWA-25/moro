...
const UnrecognizedDiag: React.FC<{ data: any; rawText?: string; toolName: string }> = ({ data, rawText, toolName }) => {
    ...
    return (
        <div className="bg-white/70 rounded-lg border-2 border-[#eed6df]">
            <div className="px-2 pt-2 pb-1.5 flex items-center gap-1.5">
                <span className="text-[9px] px-1.5 py-0.5 bg-[#fff4f7] text-[#5a3140] rounded-full font-bold">⚠️ 未识别结构</span>
