        ...
        <div className="space-y-5">
            ...
            <section className={groupClass}>
                ...
                <div className={`moro-chat-root overflow-hidden rounded-[28px] ${shellClass(chromeStyle)}`} style={backgroundStyleForPreview(backgroundStyle, chromeStyle)}>
                    ...
                    <div className={`moro-chat-header relative ${headerClass} ${previewPad}`}>
                        <div className={`flex items-center gap-3 ${headerAlign === 'center' ? 'justify-center text-center' : 'justify-between text-left'}`}>
                            <div className={`flex items-center gap-3 ${headerAlign === 'center' ? 'justify-center' : ''}`}>
                                <div
                                    className={`moro-chat-avatar ${avatarClass(avatarShape, avatarSize)} shrink-0`}
                                    style={{
                                ...
                                />
                                <div className={`moro-chat-status ${headerAlign === 'center' ? 'flex flex-col items-center' : ''}`}>
                                    <div className={`moro-chat-name text-xs font-bold ${headerTextClass}`}>聊天对象</div>
                    ...
                    <div className={`moro-chat-inputbar border-t px-3 py-3 ${chromeStyle === 'pixel' ? 'border-[#8f674a] bg-[#eadfce]' : headerStyle === 'discord' ? 'border-white/10 bg-slate-900/90' : 'border-slate-100 bg-white/80'}`}>
